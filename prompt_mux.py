...
# Send a GET request to the track_url
...
while True:
    ...
    if 'data' in track_response_dict:
        ...
        # Check if the status has changed to 'COMPLETE' and get the output
